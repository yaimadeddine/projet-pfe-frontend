...
export default function UpdateMateriel() {
  ...
  const update = async (e) => {
    ...
    try {
      const res = await axios.post(`http://127.0.0.1:8000/api/update/materiel/${id}`, {
        matricule: matricule,
        prix: prix,
        type_id: type,
        post_id: post,
        ...
        <div className="row mb-2 ">
          ...
          <div className="col-sm-6">
            <ol className="breadcrumb float-sm-right">
              ...
              <li className="breadcrumb-item active">Modifier un materiel</li>
            </ol>
          </div>
        </div>
      </div>
        ...
        <div className="col-md-5">
          <div className="card card-navy">
            <div className="card-header">
              <h3 className="card-title">Modifier un materiel</h3>
