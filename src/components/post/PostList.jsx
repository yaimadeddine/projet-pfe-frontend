  ...
  const tableRow = data.map((data, index) => {
    return (
      <tr>
        ...
        <td className="col-sm-1 text-center">{data.user_name}</td>
        <td className="text-center">{data.salle_numero}</td>
        <td className="col-sm-2 text-center">
          ...
          <button
            ...
            onClick={(e) => deleteSalle(e, data.id)}
          >
            Supprimer
          </button>
        </td>
          ...
          <div className="container-fluid">
            <div className="row mb-2">
              <div className="col-sm-6">
                <h1>La liste des postes de travail</h1>
              </div>
              <div className="col-sm-6">
                <ol className="breadcrumb float-sm-right">
                  ...
                  <li className="breadcrumb-item active">Postes List</li>
                </ol>
              </div>
            </div>
          </div>
                    ...
                    >
                      <thead>
                        <tr>
                          ...
                          <th className="col-sm-1 text-center">Utilisateur</th>
