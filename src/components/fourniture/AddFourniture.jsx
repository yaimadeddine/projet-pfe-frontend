...
export default function AddFourniture() {
  ...
  useEffect(() => {
    ...
    const createMateriel = async (e) => {
      e.preventDefault();
      try {
        const res = await axios.post("http://127.0.0.1:8000/api/create/fourniture",{
          matricule: matricule,
          prix: prix,
        ...
        <div className="row mb-2 ">
          ...
          <div className="col-sm-6">
            <ol className="breadcrumb float-sm-right">
              ...
              <li className="breadcrumb-item active">Ajouter une fourniture</li>
            </ol>
          </div>
        </div>
      </div>
        ...
        <div className="col-md-5">
          <div className="card card-navy">
            <div className="card-header">
              <h3 className="card-title">Ajouter une fourniture</h3>
